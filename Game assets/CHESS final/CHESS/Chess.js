...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 == 0) {
            color.style.backgroundColor = 'rgb(204, 162, 25)'
        }
        if (a % 2 !== 0) {
            color.style.backgroundColor = 'rgb(255, 236, 94)'
        }
        // if (a % 2 == 0) {
            ...
            document.querySelectorAll('.box').forEach(i2 => {
                ...
                if (i2.style.backgroundColor == 'green' && i2.innerText.length !== 0) {
                    ...
                    if (a % 2 == 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = 'rgb(250, 103, 69)'
                    }
                    if (a % 2 !== 0 && pinkColor == greenColor) {
                        i2.style.backgroundColor = 'rgb(219, 169, 144)'
                    }
